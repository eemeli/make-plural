...
.PHONY: build release-check-init release-check-branch release-check-head release
...
release: build release-check-init release-check-branch release-check-head
